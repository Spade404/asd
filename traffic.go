...
/*
	Hi, I'm Duc Thanh  - aka Owner CMSTP = Website Developer + Security Researcher 🌱
	...
	Buy for me a coffee
	Momo: 0773681103 Bùi Tấn Phát
	MBBank: 0773681103 Bùi Tấn Phát
	ZaloPay: 0773681103 Bùi Tấn Phát
*/
...
var (
	...
	headersUseragents []string = []string{
		"Nhập UserAgent Hoặc IP Vào Đây, Mỗi IP Hoặc UserAgent Phải Xuống Dòng",
	}
	cur int32
)
...
func main() {
	...
	if err != nil {
		maxproc = 512 //TỐC ĐỘ 512, 1024, 2048, 4096
	}
